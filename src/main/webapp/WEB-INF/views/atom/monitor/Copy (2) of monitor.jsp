...
<div class="wrap monitoring">
    ...
    <div class="sub_body">
        <div class="tree_wrap">
               <div class="filter">
                     <div class="common">
                           <p class="search"><input type="text" id="treeSearch" name="txtbox" placeholder="<spring:message code="label.common.search.text"/>"/><button type="button" title="<spring:message code="label.common.search.text"/>" class="srh">Search</button></p>
                     </div>                     
               </div>
               <!--// filter -->
               <!-- <a href="javascript:fnExpandAll();">tree expends all</a>
               <a href="javascript:fnCollapseAll();">tree Collapse </a> -->  
               <div id="jstree" class="tree jstree jstree-1 jstree-default jstree-closed"></div>
               <!--// tree --> 
        </div>  
         <!--// tree_wrap -->   
    ...
    <div class="sub_bottom">
            <div class="alarm_adjustment">
                <div class="select_single common">
                    <select class="single">
                        <option value="Select" selected>Node Name</option>
                        <option value="01">Code</option>
                        <option value="02">Severity</option>
                    </select>
                </div>
                <div class="common">
                    <p class="search"><input type="text" name="txtbox" placeholder="Search"/><button type="button" title="Search" class="srh">Search</button></p>
                </div>
                <div class="table_info_group1">
                    <div class="paging">
                        <ul>
                            <li><a href="#" class="first"><span class="hidden">First</span></a></li>
                            <li><a href="#none" class="before"><span class="hidden">Before</span></a></li>
                            <li><input type="text" name="page" value="0" />/ <span id="last_page">0</span></li>
                ...
                <div class="table_info_group3">
                        ...
                        <button type="button" title="더 보기" class="icon6">더 보기</button>
                </div>                
            </div>
            <!--// alarm adjustment -->
            ...
            <div class="data">
                ...
                <div class="scroll table hover_event">
                    <table class="tbl_list type2">
                        <colgroup>
                            <col />
                            <col />
