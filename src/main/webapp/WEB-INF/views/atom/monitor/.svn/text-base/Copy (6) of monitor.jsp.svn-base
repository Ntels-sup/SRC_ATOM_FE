...
=======
		} else if (command == 20002) { //노드 상태
>>>>>>> .r1807
			$.jstree.destroy();
			fnMessageInitTree();
			networkDiagramFrame.reloadNodeStatus(messages);
<<<<<<< .mine
		} else if ((command == 20004) || (command == 20018)) { //노드 라인 상태가 갱신하여야 한다.
		} 
=======
...
>>>>>>> .r1807
	...
	//var resourceChart = AmCharts.makeChart("chart_colum1", chartConfig2);
	//var resourceChart = AmCharts.makeChart("chart_colum2", chartConfig2);
	//var resourceChart = AmCharts.makeChart("chart_colum3", chartConfig2);
	//var resourceChart = AmCharts.makeChart("chart_colum4", chartConfig2);
