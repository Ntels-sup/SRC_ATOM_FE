...
<!--
	...
	$(document).ready(function() {
		...
		//알람 context menu
		$(document).on("contextmenu", "#alarmList td:first-child", function(e) {
			var $this = $(this);
			console.log($this);
	...
	function fnSeverityCount() {
		...
		$("#warning_count").text(fault_count + notice_count);
...
<div class="wrap monitoring">
    ...
    <div class="sub_bottom"> <!--// 창확대 addclass:on -->    	
            <div class="alarm_adjustment">
                ...
                <div class="common">
                    <p class="search"><input type="text" name="search" placeholder="<spring:message code="label.common.search"/>"/><button type="button" title="<spring:message code="label.common.search"/>" class="srh">Search</button></p>
                </div>
                <div class="table_info_group1">
                    <div class="paging">
                        <ul>
                            <li><a href="javascript:fnPageMove('first');" class="first"><span class="hidden">First</span></a></li><!--hidden 처리-->
