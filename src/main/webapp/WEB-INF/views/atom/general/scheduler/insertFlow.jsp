...
<script type="text/javascript" src="<c:url value="/scripts/jquery/jquery.alphanumeric.js" />"></script>
...
<!--
	...
	function insertBatchFlow() {
		...
		if (!/^[0-9]+$/.test($("#exit_value").val())) {
			alert('<spring:message code="msg.pfnm.batch.exit_value.text.invalid"/>');
			$("#exit_value").focus();
			return;
		}
		
		opener.g_connection = null;
		opener.clearInterval(opener.g_interval);
		opener.g_interval = null;
		...
		<section>
			...
			<article>
				<form id="frm" name="frm" method="post"
					action="/pfnm/designer/batch/insertFlowAction.ajax">
				...
				<table class="modif">
					...
					<tr>
						...
						<td><input type="text" id="exit_value" name="exit_value">
						</td>
					</tr>
					<tr>
				...
				<div class="pop_btn">
					<a href="javascript:insertBatchFlow();" class="button"><span><spring:message code="label.common.button.save.text"/></span>
					</a> 
