...
<!--
	...
	function deleteBatchGroup() {
		...
		frm.action = "/pfnm/designer/batch/deleteBatchGroupAction.ajax";
		frm.submit();
		
		opener.location.href="/pfnm/designer/batch/list?system_id=${batchGroup.system_id}";	
	}	
		...
		<section>
			...
			<article>
				<form id="frm" name="frm" method="post"
					action="/pfnm/designer/batch/updateBatchGroupAction.ajax">
				<input type="hidden" name="system_id" value="${batchGroup.system_id}"/>
				<input type="hidden" name="package_id" value="${batchGroup.package_id}"/>
				<input type="hidden" name="batch_group_id" value="${batchGroup.batch_group_id}"/>
				<input type="hidden" name="user_id" value="test"/>
				<input type="hidden" name="call_flag" value="popup"/>
				...
				<div class="pop_btn">
					<a href="javascript:updateBatchGroup();" class="button"><span><spring:message code="label.common.button.save.text"/></span>
					</a> 
					<a href="javascript:deleteBatchGroup();" class="button"><span><spring:message code="label.common.button.delete.text"/></span>
					</a> 					
