...
<%@ taglib uri="/WEB-INF/tag/ntels.tld" prefix="ntels"%>
		<section>
			<header>
				<spring:message code="label.pfnm.batch.rename.text"/><a href="javascript:closeWindow();"><spring:message code="label.pfnm.batch.close.text"/></a>
			</header>
			<article>
				<form id="pop" name="pop" method="post"
					action="/pfnm/designer/batch/updateByRenameAction.ajax">		
				...
				<div class="pop_btn">
					<a href="javascript:goBatch('rename');" class="button"><span><spring:message code="label.common.button.ok.text"/></span>
