...
var language = '${language}';
	...
	function fnExcel(){
    	if($("tbody > tr > td").html() == '<spring:message code="label.empty.list" />') {
        	openAlertModal('<spring:message code="msg.common.excel.download.restore" />');
            return;
        }
			...
			<div class="search_area">
				<div>
					<div class="select_period">
						<label><spring:message code="label.general.history.restore.period.text"/></label>
						<div class="period">
							<!-- StartDate -->
					...
					<div class="select_group">
						<label><spring:message code="label.general.history.restore.PackageSystem.text"/></label>
					...
					<div class="select_single"><label><spring:message code="label.general.history.restore.category.text" /></label>
