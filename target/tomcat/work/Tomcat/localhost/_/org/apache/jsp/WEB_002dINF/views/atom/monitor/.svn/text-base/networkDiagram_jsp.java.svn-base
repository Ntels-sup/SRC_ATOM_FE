...
public final class networkDiagram_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\taddNodeFigure(node);\r\n");
      out.write("\t}\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("// websocket 20002 action\r\n");
      out.write("// change node color\r\n");
      out.write("// change node count\r\n");
      out.write("function reloadNodeStatus(messages) {\r\n");
      out.write("\tvar param = new Object();\r\n");
      out.write("\t$.ajax({\r\n");
      out.write("\t\turl: \"reloadNodeStatus\",\r\n");
      out.write("\t\tdata: param,\r\n");
      out.write("\t\ttype: 'POST',\r\n");
      out.write("\t\tdataType: 'json',\r\n");
      out.write("\t\tsuccess: function(data) {\r\n");
      out.write("\t\t\tvar nodeList = data.nodeList;\r\n");
      out.write("\t\t\tvar allNodeList = data.allNodeList;\r\n");
      out.write("\t\t\tg_data.nodeList = nodeList;\r\n");
      out.write("\t\t\tg_data.allNodeList = allNodeList;\r\n");
      out.write("\t\t\tfor (var i=0;i<nodeList.length;i++) {\r\n");
      out.write("\t\t\t\tvar node = nodeList[i];\r\n");
      out.write("\t\t\t\tvar image_uuid = node.image_uuid;\r\n");
      out.write("\t\t\t\tif (!isEmpty(image_uuid)) {\r\n");
      out.write("\t\t\t\t\tvar atomNode = g_canvas.getFigure(image_uuid);\r\n");
      out.write("\t\t\t\t\tif (atomNode !== null) {\r\n");
      out.write("\t\t\t\t\t\tatomNode.setBackgroundColor(node.image_bgcolor);\r\n");
      out.write("\t\t\t\t\t\tif (atomNode.atomCount != null) {\r\n");
      out.write("\t\t\t\t\t\t\tatomNode.atomCount.atomLabel.setText(node.node_count);\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\tatomNode = g_minimap.getFigure(image_uuid);\r\n");
      out.write("\t\t\t\t\tif (atomNode !== null) {\r\n");
      out.write("\t\t\t\t\t\tatomNode.setBackgroundColor(node.image_bgcolor);\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t}\r\n");
      ...
      out.write("}\r\n");
      out.write("\r\n");
      out.write("//websocket 20004, 20018 action\r\n");
      out.write("//change line color\r\n");
      out.write("//change line count\r\n");
      out.write("function reloadConnectionStatus(messages) {\r\n");
      out.write("\tvar param = new Object();\r\n");
      out.write("\t$.ajax({\r\n");
      out.write("\t\turl: \"reloadConnectionStatus\",\r\n");
      out.write("\t\tdata: param,\r\n");
      out.write("\t\ttype: 'POST',\r\n");
      out.write("\t\tdataType: 'json',\r\n");
      out.write("\t\tsuccess: function(data) {\r\n");
      out.write("\t\t\tg_data.connectionList = data.connectionList;\r\n");
      out.write("\t\t\tvar lines = g_canvas.lines.data;\r\n");
      out.write("\t\t\tfor (var i=0;i<lines.length;i++) {\r\n");
      out.write("\t\t\t\tvar line = lines[i];\r\n");
      out.write("\t\t\t\tline.level = null;\r\n");
      out.write("\t\t\t\tvar userData = line.userData;\r\n");
      out.write("\t\t\t\tline.setUserData(userData);\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t}\r\n");
      out.write("\t});\r\n");
      out.write("}\r\n");
      out.write("</script>\r\n");
      out.write("<div class=\"draw type2\">\r\n");
  ...
  private boolean _jspx_meth_spring_005fmessage_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/views/atom/monitor/networkDiagram.jsp(105,56) name = code type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_spring_005fmessage_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/views/atom/monitor/networkDiagram.jsp(105,149) name = code type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_spring_005fmessage_005f2(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/views/atom/monitor/networkDiagram.jsp(106,57) name = code type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_spring_005fmessage_005f3(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/views/atom/monitor/networkDiagram.jsp(106,152) name = code type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_spring_005fmessage_005f4(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/views/atom/monitor/networkDiagram.jsp(107,59) name = code type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_spring_005fmessage_005f5(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/views/atom/monitor/networkDiagram.jsp(107,150) name = code type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_spring_005fmessage_005f6(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/views/atom/monitor/networkDiagram.jsp(108,63) name = code type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_spring_005fmessage_005f7(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/views/atom/monitor/networkDiagram.jsp(108,161) name = code type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
